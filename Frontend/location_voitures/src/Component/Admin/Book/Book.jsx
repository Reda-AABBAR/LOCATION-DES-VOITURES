...
function Book() {
    ...
    useEffect(() => {
      ...
      const getAllBook = async () => {
        try {
          const result = await axios.get(" http://localhost:8080/reservations/NotConfermed");
          console.log(result);
      ...
      const bookConfirm =async(id)=>{
        try {
         await axios.put(`  http://localhost:8080/reservations/confermed/${id}`);
         getAllBook();
        } catch (error) {
