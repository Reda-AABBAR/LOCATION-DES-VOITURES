    ...
    useEffect (()=>{
      ...
      const onSubmit = async (e) => {
        ...
        try {
            ...
            const result = await axios.put(`http://localhost:8080/vehicules/${id}`, {
                ...vehicle,
                prixParJour,
                kilometrage,
            });
  ...
  return (
    <div style={{height:'100vh',display: 'flex', justifyContent: 'space-around',marginBottom:'6%'}}>
                ...
                <div style={{justifyContent:'space-around',display: 'flex'}}>
                        ...
                        <div style={{width:'50vw',justifyContent:'center',justifyContent:'center',padding:'30px'}}>
                            ...
                            <div className="d-flex justify-content-around align-items-center">
                                ...
                                <Link  className="btn btn-danger py-2 m-0" to='/car' style={{marginLeft:'40px'}} >Cancel</Link>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div  style={{width:'30vw',height:'100vh',backgroundColor: '#1a237e'}}>
            ...
            <div  style={{ color: '#1a237e' ,backgroundColor:'#d3d3d3',height:'55px' }}><h2>Edit constraint</h2></div>
